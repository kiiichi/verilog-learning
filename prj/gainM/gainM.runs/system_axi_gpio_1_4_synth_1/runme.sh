...
HD_PWD='C:/Users/rinu2/Documents/kichi@git/RedPitaya-FPGA/prj/Examples/delay/freq/freq.runs/system_axi_gpio_1_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_1_4.tcl
