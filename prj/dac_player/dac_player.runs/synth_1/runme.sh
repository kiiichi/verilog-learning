...
HD_PWD='C:/Users/rinu2/Documents/kichi@git/verilog-learning/prj/dac_player/dac_player.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_hub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_hub.tcl
