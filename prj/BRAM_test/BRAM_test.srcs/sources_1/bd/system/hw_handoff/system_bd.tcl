...
proc create_hier_cell_dac { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_PORT1

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_PORT2
...
proc create_hier_cell_PS7 { parentCell nameHier } {
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DIO_combine_0, and set properties
  set block_name DIO_combine
  set block_cell_name DIO_combine_0
  if { [catch {set DIO_combine_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DIO_combine_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net PS7_M02_AXI [get_bd_intf_pins PS7/M02_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net PS7_M03_AXI [get_bd_intf_pins PS7/M03_AXI] [get_bd_intf_pins pl_ram_ctrl_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net pl_ram_ctrl_0_BRAM_PORT [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins pl_ram_ctrl_0/BRAM_PORT]
  ...
  connect_bd_intf_net -intf_net signal_split_0_M_AXIS_PORT1 [get_bd_intf_pins dac/S_AXIS_PORT1] [get_bd_intf_pins signal_split_0/M_AXIS_PORT1]
  connect_bd_intf_net -intf_net signal_split_0_M_AXIS_PORT2 [get_bd_intf_pins dac/S_AXIS_PORT2] [get_bd_intf_pins signal_split_0/M_AXIS_PORT2]
  ...
  connect_bd_net -net pl_ram_ctrl_0_write_end [get_bd_pins PS7/IRQ_F2P] [get_bd_pins pl_ram_ctrl_0/write_end]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DIO_combine_0/DIO_PORT0_data] [get_bd_pins PS7/FCLK_CLK0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins pl_ram_ctrl_0/s00_axi_aclk]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins PS7/S00_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins pl_ram_ctrl_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs pl_ram_ctrl_0/S00_AXI/S00_AXI_reg] -force
