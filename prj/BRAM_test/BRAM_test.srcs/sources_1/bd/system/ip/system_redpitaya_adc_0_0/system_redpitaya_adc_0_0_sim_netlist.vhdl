...
--               c:/Users/rinu2/Documents/kichi@git/verilog-learning/prj/transmitter/transmitter.srcs/sources_1/bd/system/ip/system_redpitaya_adc_0_0/system_redpitaya_adc_0_0_sim_netlist.vhdl
...
entity system_redpitaya_adc_0_0_redpitaya_adc is
  port (
  ...
  attribute ORIG_REF_NAME of system_redpitaya_adc_0_0_redpitaya_adc : entity is "redpitaya_adc";
end system_redpitaya_adc_0_0_redpitaya_adc;

architecture STRUCTURE of system_redpitaya_adc_0_0_redpitaya_adc is
...
entity system_redpitaya_adc_0_0 is
  ...
  attribute NotValidForBitStream of system_redpitaya_adc_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_redpitaya_adc_0_0 : entity is "system_redpitaya_adc_0_0,redpitaya_adc,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_redpitaya_adc_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_redpitaya_adc_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_redpitaya_adc_0_0 : entity is "redpitaya_adc,Vivado 2020.1";
end system_redpitaya_adc_0_0;

architecture STRUCTURE of system_redpitaya_adc_0_0 is
  signal \<const1>\ : STD_LOGIC;
  signal \^m_axis_tdata\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of adc_clk : signal is "xilinx.com:signal:clock:1.0 adc_clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of adc_clk : signal is "XIL_INTERFACENAME adc_clk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN system_redpitaya_adc_0_0_adc_clk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tdata : signal is "XIL_INTERFACENAME m_axis, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 125000000, PHASE 0.000, LAYERED_METADATA undef, INSERT_VIP 0";
begin
  adc_csn <= \<const1>\;
...
inst: entity work.system_redpitaya_adc_0_0_redpitaya_adc
     port map (
      adc_clk => adc_clk,
      adc_clk_n => adc_clk_n,
      adc_clk_p => adc_clk_p,
